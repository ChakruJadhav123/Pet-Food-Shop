<?php
    ...
    $sql = "INSERT INTO `product` (`id`, `pcode`, `time`) VALUES (NULL, 'p4', current_timestamp());";
            ...
            <div class="box">
                ...
                <?php
                    if($con->query($sql) == true){
                        echo "<center><h2 color:green;>Ordered Successfully... Our vender will contact you soon...</h2></center>";
                    }
                ?>
                <div class="content">
